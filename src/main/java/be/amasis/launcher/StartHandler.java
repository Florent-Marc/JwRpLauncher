...
public class StartHandler {
    ...
    public static Color COLOR_APPHEADER = new Color(64,64,64);
    public static Color TRANSPARENT = new Color(0,0,0,0);
    public static String NAME = "JwRp";
    public static String TITLE = NAME + " launcher";
    public static int HEIGHT = 600, WIDTH = (int) (HEIGHT * 1.77);//Format 14:9 600 » 1067
