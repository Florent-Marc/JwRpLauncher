...
public class MainPanel extends JPanel implements MouseListener {
    ...
    private void drawElements() {
        AppHeader appHeader = new AppHeader(this,"JwRp || V1.0", StartHandler.WIDTH);
        ...
        savePwd.setForeground(new Color(255,255,255));
        ...
        userLabel.setBounds(StartHandler.getCenteredXPos(350), 120,350,50);
        add(userLabel);
